      ...
      <SignedOut>
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-cover bg-center" style={{ 
            backgroundImage: "url('https://diplomatist.com/wp-content/uploads/2020/08/agri.jpg')",
        ...
        {/* Feature Cards */}
          <div className="container mx-auto px-4 mt-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <FeatureCard 
                ...
                description="Analyze crop price trends and make smarter selling decisions"
              />
          ...
          {/* <div className="mt-24 text-center container mx-auto px-4">
...
<div id="how-it-works" className="mt-24 py-16 bg-gradient-to-br from-green-900 to-green-800">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
      ...
      <SignedIn>
        <div className="container mx-auto px-4 pt-16 pb-24 text-center">
          ...
          <p className="text-xl mb-8">Choose an option from the menu below to get started</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Link to="/climate">
            ...
            <Link to="/detection">
              <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <p className="text-gray-600">Detect plant diseases and get treatment options</p>
              </div>
            </Link>
          </div>
        </div>
      </SignedIn>
      <footer className="bg-green-200 text-green-500 py-4 text-center">
        <div className="container mx-auto">
          <p className="text-black text-sm">© {new Date().getFullYear()} KrishiMitra. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
...
const StepCard = ({ number, title, description }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <h3 className="text-2xl mb-2 text-white font-extrabold">{title}</h3>
